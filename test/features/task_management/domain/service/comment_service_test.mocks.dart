...
// in kanban_board/test/features/task_management/domain/service/comment_service_test.dart.
...
class MockCommentRepository extends _i1.Mock implements _i3.CommentRepository {
  ...
  @override
  _i4.Future<List<_i2.Comment>> fetchComments(String? taskId) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i2.Comment> addComment(_i2.Comment? comment) =>
      (super.noSuchMethod(
            Invocation.method(#addComment, [comment]),
            returnValue: _i4.Future<_i2.Comment>.value(
              _FakeComment_0(this, Invocation.method(#addComment, [comment])),
            ),
          )
