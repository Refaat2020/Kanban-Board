...
// in kanban_board/test/features/task_management/domain/service/task_management_service_test.dart.
...
class MockTaskManagementRepository extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.Task> updateTask(_i2.Task? task, String? taskId) =>
      (super.noSuchMethod(
            Invocation.method(#updateTask, [task, taskId]),
            returnValue: _i4.Future<_i2.Task>.value(
              _FakeTask_0(this, Invocation.method(#updateTask, [task, taskId])),
            ),
          )
          as _i4.Future<_i2.Task>);
}
