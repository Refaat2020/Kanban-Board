...
// in kanban_board/test/features/kanban_board/domain/service/task_service_test.dart.
...
class MockTaskRepository extends _i1.Mock implements _i2.TaskRepository {
  ...
  @override
  _i3.Future<List<_i4.Task>> fetchTasks(String? projectId) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> initialSync(String? projectId) =>
      (super.noSuchMethod(
            Invocation.method(#initialSync, [projectId]),
