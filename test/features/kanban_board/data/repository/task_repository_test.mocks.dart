...
// in kanban_board/test/features/kanban_board/data/repository/task_repository_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTaskDataSource extends _i1.Mock implements _i6.TaskDataSource {
  MockTaskDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<dynamic>> fetchTasks(String? projectId) =>
      (super.noSuchMethod(
