...
import '../../../../task_management/presentation/views/completed_task/history_screen.dart';
import '../../../../task_management/presentation/views/create_task/create_task_screen.dart';
import '../../../domain/entities/task.dart';
import '../../cubit/kanban_cubit.dart';
import 'components/filtered_tasks_view.dart';
...
class _BoardScreenState extends State<BoardScreen> {
  ...
  void initState() {
    ...
    kanbanCubit.syncTasks(_projectId).then((value) =>  kanbanCubit.fetchTasks(_projectId),);
  }
